...
Revision ID: c1a585deb001
Revises: 
Create Date: 2023-01-12 23:28:02.323352
...
def upgrade():
    ...
    sa.Column('next_action_remarks', sa.VARCHAR(length=255), nullable=True),
    ...
    sa.Column('broadcast', sa.VARCHAR(length=255), nullable=True),
