...
def fetch_and_insert_data(last_submission_id):
    ...
    for row in cursor.mappings():
        ...
        for row_2 in join_cursor.mappings():
            ...
            elif row_2['key'] == 'field_4b05454' or row_2['key'] == 'field_a7b7060' or row_2['key'] == 'field_827f28a' or row_2['key'] == 'field_8f939e3' or row_2['key'] == 'field_05c825a' or row_2['key'] == 'phone' :
